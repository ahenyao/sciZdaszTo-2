...
public partial class Inf04 : ViewModelBase
{
    ...
    private async void ShowEndScreen()
    {
        ...
        if (App.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            if (window != null)
            {
                var testView = window.FindControl<UserControl>("Inf04");
        ...
        else if (App.Current?.ApplicationLifetime is ISingleViewApplicationLifetime mobile)
        {
            ...
            if (root != null)
            {
                var testView = FindControlRecursive(root, "Inf04");
